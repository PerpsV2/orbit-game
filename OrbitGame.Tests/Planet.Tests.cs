...
public class Planet_Tests
{
    ...
    public Planet_Tests(ITestOutputHelper output)
    {
        ...
        _output = output;
        _testPlanet = _testPlanetTemplate.CreateInstance("Test Planet", new(DVector2<SDecimal>.Zero, Math.PI / 2), 
            1, 10000, Color.White, null);
        
        SpatialInfo cameraSpatialInfo = new(position: new DVector2<SDecimal>(10000, 0));
        ...
        cameraSpatialInfo = new(position: DVector2<SDecimal>.Zero);
