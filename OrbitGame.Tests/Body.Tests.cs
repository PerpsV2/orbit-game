...
public class Body_Tests
{
    ...
    public Body_Tests(ITestOutputHelper output)
    {
        ...
        _testBody2 = _template.CreateTestInstance("Test Body 2", new SpatialInfo(
                position: new SD_Vector2(0, 0),
                velocity: new SD_Vector2(0, 0)),
            4, null);
        _testBody1 = _template.CreateTestInstance("Test Body 1", new SpatialInfo(
                position: new SD_Vector2(1, 0),
                velocity: new SD_Vector2(0, 2),
                angularVelocity: 1),
            1, _testBody2);
    }
    ...
    {
        Assert.Equal(new SD_Vector2(-4, 0), _testBody1.CalculateNetAcceleration());
        Assert.Equal(new SD_Vector2(1, 0), _testBody2.CalculateNetAcceleration());
    }
    ...
    public void Body_UpdatePosition_IntegratorExplicitEulerMethod()
    {
        ...
        _testBody1.UpdatePosition_Integrator(1, NumericalIntegrator.ExplicitEuler, () => new SD_Vector2(1, 0), 1);
        Assert.Equal(new SD_Vector2(1, 2), _testBody1.Velocity);
        Assert.Equal(new SD_Vector2(2, 2), _testBody1.Position);
    ...
    {
        _testBody1.AngularAcceleration = 1;
        _testBody1.UpdatePosition_Integrator(1, NumericalIntegrator.ImplicitEuler, () => new SD_Vector2(1, 0), 1);
        ...
        Assert.Equal(new SD_Vector2(1, 2), _testBody1.Velocity);
        Assert.Equal(new SD_Vector2(1, 2), _testBody1.Position);
        Assert.Equal(2, _testBody1.AngularVelocity);
        Assert.Equal(2, _testBody1.Angle);
    }
    ...
    {
        _testBody1.AngularAcceleration = 1;
        _testBody1.UpdatePosition_Integrator(1, NumericalIntegrator.VelocityVerlet, () => new SD_Vector2(1, 0), 1);
    ...
    {
        _testBody1.AngularAcceleration = 1;
        _testBody1.UpdatePosition_Integrator(1, NumericalIntegrator.RungeKutta4, () => new SD_Vector2(1, 0), 1);
    ...
    public void Body_UpdatePosition_KeplerMethod()
    {
        ...
        Assert.Equal(new SD_Vector2(0, -2), _testBody1.Velocity);
        Assert.Equal(new SD_Vector2(-1, 0), _testBody1.Position);
        Assert.Equal(2, _testBody1.AngularVelocity);
        Assert.Equal(2, _testBody1.Angle);
    }
}