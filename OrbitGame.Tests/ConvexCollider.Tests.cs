...
{
    private readonly ConvexCollider _testEmptyPointCollider = new([DVector2<SDecimal>.Zero]);
    private readonly ConvexCollider _testEmptyLineCollider = new([DVector2<SDecimal>.Zero, new DVector2<SDecimal>(5, 0)]);
    ...
    public void ConvexCollider_IntersectsWithPointMethod()
    {
        ...
        DVector2<SDecimal> overlappingPoint = DVector2<SDecimal>.Zero;
        DVector2<SDecimal> touchingPoint = new DVector2<SDecimal>(1, 0);
        DVector2<SDecimal> notTouchingPoint = new DVector2<SDecimal>(5, 0);
    ...
    {
        SpatialInfo originSpatialInfo = new(DVector2<SDecimal>.Zero);
        ...
        Assert.Equal(new PhysicsCollision(originSpatialInfo, touchingSpatialInfo, [new(1, 0)], DVector2<SDecimal>.Zero),
    ...
    {
        SpatialInfo originSpatialInfo = new(DVector2<SDecimal>.Zero, 0);
        SpatialInfo nearsCircularSpatialInfo = new(new DVector2<SDecimal>(2 - 0.1, 3 - 0.1), 0);
        SpatialInfo nearsConvexSpatialInfo = new(new DVector2<SDecimal>(3, 0), Math.PI / 2);
