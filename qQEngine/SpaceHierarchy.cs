...
public class SpaceHierarchy
{
    private class KDTree
    {
        ...
        public KDLeafNode GetPositionLeafNode(Vec2 position)
        {
        ...
        private List<KinematicObject> TraverseBranch(KDTreeNode rootNode, Vec2 queryPosition, SDecimal radius)
        {
        ...
        public List<KinematicObject> GetObjectsInRadius(Vec2 queryPosition, SDecimal radius)
        {
    ...
    public class KDLeafNode(List<KinematicObject> objs) : KDTreeNode
    {
        ...
        public bool ObjectWithinRadius(Vec2 queryPosition, SDecimal radius)
            => (Objects[0].Position - queryPosition).MagnitudeSquared() <= radius * radius;
    }

    private class KDBranchNode(int axis, SDecimal median, KDTreeNode left, KDTreeNode right) : KDTreeNode
    {
        ...
        public int GetSide(Vec2 position)
        {
        ...
        public bool RadiusIntersectsPlane(Vec2 queryPosition, SDecimal radius)
