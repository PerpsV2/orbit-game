...
public class Camera : KinematicObject
{
    ...
    /// </summary>
    public Vec2 TopLeft 
        => Position + Vec2.RotatePoint(new(-Width * 0.5, Height * 0.5), -Angle);
    ...
    public Vec2 SD_ConvertToWorldCoordinates(Vec2 point)
    ...
    /// <returns>Point in world space.</returns>
    public Vec2 ConvertToWorldCoordinates(Vector2 point)
    ...
    public Vec2 SD_ConvertToScreenCoordinates(Vec2 point)
    ...
    public Vector2 ConvertToScreenCoordinates(Vec2 point)
    {
        Vec2 transformedPoint = SD_ConvertToScreenCoordinates(point);
